...
sleep 5
cd /bin || exit
wget https://raw.githubusercontent.com/1megalodon/MEGAX9/main/Modulos/initcheck > /dev/null 2>&1
wget https://raw.githubusercontent.com/1megalodon/MEGAX9/main/Modulos/userscheck > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/1megalodon/MEGAX9/main/Modulos/checkuser.py > /dev/null 2>&1
